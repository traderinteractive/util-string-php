...
We welcome you to report [issues](https://github.com/dominionenterprises/util-string-php/issues) or submit
[pull requests](https://github.com/dominionenterprises/util-string-php/pulls).  While the below guidelines are necessary to get code merged, you can
...
## Travis CI
Our [Travis build](https://travis-ci.org/dominionenterprises/util-string-php) executes the build above against pull requests.
